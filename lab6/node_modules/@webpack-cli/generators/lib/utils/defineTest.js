 ...
 */
function runSingleTransform(dirName, transformName, testFilePrefix, initOptions, action) {
    if (!testFilePrefix) {
 ...
 */
function defineTest(dirName, transformName, testFilePrefix, transformObject, action) {
